...
class BloodOxygenNotifier extends AsyncNotifier<List<BloodOxygenEntity>> {
  late DateTime _from;
  late DateTime _to;
  ...
  @override
  Future<List<BloodOxygenEntity>> build() async {
  ...
  Future<List<BloodOxygenEntity>> fetch({
    required String userId,
    required DateTime from,
    required DateTime to,
  }) async {
    final usecase = ref.read(getBloodOxygenUsecaseProvider);
  ...
  Future<void> insert({
    ...
    final usecase = ref.read(insertBloodOxygenUsecaseProvider);
  ...
  Future<void> updateMetric({
    ...
    final usecase = ref.read(updateBloodOxygenUsecaseProvider);
...
final bloodOxygenProvider =
    AsyncNotifierProvider<BloodOxygenNotifier, List<BloodOxygenEntity>>(
      BloodOxygenNotifier.new,
    );
